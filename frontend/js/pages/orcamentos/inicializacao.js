 ...
 */
  ...
  function bindEvents() {
    ...
    $('btn-budget-export-repair')?.addEventListener('click', () => $('input-budget-export-repair')?.click());
    $('input-budget-export-repair')?.addEventListener('change', (event) => {
      void repairBudgetLegacyAttachments(event.target.files);
    });
